...
//        CoStorage.shared.saveRecord(with: .init(platform: "Spotify", entry: "@zidak", password: "zidakADLC__3333", category: .app))
//        CoStorage.shared.saveRecord(with: .init(platform: "Gmail", entry: "zidak@gmail.com", password: "998H44AD&&cawis", category: .login))
//        CoStorage.shared.saveRecord(with: .init(platform: "Linkedin", entry: "/cawistan", password: "123456", category: .login))
//        CoStorage.shared.saveRecord(with: .init(platform: "Memrise", entry: "/cawistan", password: "2233445090213", category: .login))
